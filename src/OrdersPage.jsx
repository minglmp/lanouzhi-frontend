                          ...
                          <tr key={order.id} className="border-b border-[#2d2d2f] hover:bg-black/20 transition-colors">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="flex flex-col">
                                {/* 🌟 บรรทัดบน: วันที่ (บังคับ Timezone UTC+7) */}
                                <span className="text-white text-sm">
                                  {new Date(order.created_at.replace(' ', 'T') + 'Z').toLocaleDateString('en-GB', { 
                                    timeZone: 'Asia/Bangkok', // หรือใช้ 'Asia/Vientiane' ได้ครับ
                                    day: '2-digit', 
                                    month: 'short', 
                                    year: 'numeric' 
                                  })}
                                ...
                                {/* 🌟 บรรทัดล่าง: เวลา (บังคับ Timezone UTC+7) */}
                                <span className="text-xs text-gray-400 mt-0.5">
                                  {new Date(order.created_at.replace(' ', 'T') + 'Z').toLocaleTimeString('en-US', {
                                    timeZone: 'Asia/Bangkok', // หรือใช้ 'Asia/Vientiane' ได้ครับ
                                    hour: '2-digit', 
                                    minute:'2-digit'
                                  })}
